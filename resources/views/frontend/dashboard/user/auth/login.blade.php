...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('frontend/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css') }}"
    type="text/css">
  <!-- Argon CSS -->
...
<body class="my-bg">
  ...
  <script src="{{ asset('frontend/assets/vendor/jquery-scroll-lock/dist/jquery-scrollLock.min.j') }}s"></script>
  <!-- Argon JS -->
