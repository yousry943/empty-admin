...
@section('content')
@section('extraCss')
<link rel="stylesheet" href="{{ asset('frontend/assets/vendor/nestable/nestable.css') }}">
<link rel="stylesheet" href="{{ asset('frontend/assets/vendor/iconpicker/fontawesome-iconpicker.min.css') }}">
@endsection
...
<div class="container-fluid mt--6">
    ...
    @section('extraJs')
		<!-- Script links-->
			<script src="{{ asset('frontend/assets/vendor/nestable/jquery.nestable.js') }}"></script>
			<script src="{{ asset('frontend/assets/vendor/iconpicker/fontawesome-iconpicker.min.js') }}"></script>
			<!--ajax token--->
			<script>
				$.ajaxSetup({
					headers: {
